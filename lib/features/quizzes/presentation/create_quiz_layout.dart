...
import 'package:notenova/features/quizzes/presentation/state%20management/quiz_states.dart';
            ...
            SliverToBoxAdapter(
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    MyCustomTextField(baseColor: Theme.of(context).cardColor, title: LocaleKeys.title.tr()),
                    bigSizedBoxHeight,
                    MyCustomTextField(baseColor: Theme.of(context).cardColor, title: LocaleKeys.description.tr(), maxLines: 5, height: height * 0.2),
                    bigSizedBoxHeight,
                    Text(LocaleKeys.category.tr(), style: Theme.of(context).textTheme.bodySmall),
                    bigSizedBoxHeight,
                    Container(
                      height: height * 0.07,
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return Row(
                            children: [
                              CustomButton(text: getCategories(context)[index].name,
                                  onPressed: (){},
                    ...
                    TextButton(
                      onPressed: (){},
                      child: Text(LocaleKeys.add_category.tr(), style: Theme.of(context).textTheme.bodySmall),
                    ),
                    bigSizedBoxHeight,
                    BlocBuilder<QuizCubit,QuizState>(
                      builder:(context, state){
                      return CustomButton(text: 'Go to questions', onPressed: (){
                      });
                      },
